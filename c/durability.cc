...
static void
durability_callback(lcb_t, int, const lcb_RESPBASE *rb)
{
...
static void
store_callback(lcb_t instance, int, const lcb_RESPBASE *rb)
{
...
static void
do_store_and_endure(lcb_t instance)
{
    lcb_CMDSTORE scmd = { 0 };
    lcb_error_t rc;
...
static void
durstore_callback(lcb_t, int, const lcb_RESPBASE *rb)
{
...
static void
do_durstore(lcb_t instance)
{
    lcb_error_t rc;
    lcb_CMDSTOREDUR sdcmd = { 0 };
    const char *key = "docid";
    const char *value = "[1,2,3]";
